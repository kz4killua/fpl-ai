...
def make_goals_scored_predictor():
    columns = [
        ...
        "balanced_adjusted_uds_xG_per_90_rolling_mean_3",
        "balanced_adjusted_uds_xG_per_90_rolling_mean_5",
        "balanced_adjusted_uds_xG_per_90_rolling_mean_10",
        "balanced_adjusted_uds_xG_per_90_rolling_mean_20",
        ...
        "balanced_adjusted_uds_xG_share_rolling_mean_3",
        "balanced_adjusted_uds_xG_share_rolling_mean_5",
        "balanced_adjusted_uds_xG_share_rolling_mean_10",
        "balanced_adjusted_uds_xG_share_rolling_mean_20",
