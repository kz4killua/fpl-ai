...
def make_assists_predictor():
    columns = [
        ...
        "balanced_adjusted_uds_xA_per_90_rolling_mean_3",
        "balanced_adjusted_uds_xA_per_90_rolling_mean_5",
        "balanced_adjusted_uds_xA_per_90_rolling_mean_10",
        "balanced_adjusted_uds_xA_per_90_rolling_mean_20",
        ...
        "balanced_adjusted_uds_xA_share_rolling_mean_3",
        "balanced_adjusted_uds_xA_share_rolling_mean_5",
        "balanced_adjusted_uds_xA_share_rolling_mean_10",
        "balanced_adjusted_uds_xA_share_rolling_mean_20",
