...
def make_tackles_predictor():
    columns = [
        ...
        "balanced_tackles_per_90_rolling_mean_3",
        "balanced_tackles_per_90_rolling_mean_5",
        "balanced_tackles_per_90_rolling_mean_10",
        "balanced_tackles_per_90_rolling_mean_20",
    ]
